...
object ByteString {
  ...
  private[sherpa] object ByteString1C {
  ...
  final class ByteString1C private (private val bytes: Array[Byte]) extends CompactByteString {
    ...
    private[sherpa] def toByteString1: ByteString1 = ByteString1(bytes)
  ...
  private[sherpa] object ByteString1 {
  ...
  private[sherpa] object ByteStrings {
   ...
   */
  final class ByteStrings private (private[sherpa] val bytestrings: Vector[ByteString1], val length: Int) extends ByteString {
 ...
 */
sealed abstract class CompactByteString extends ByteString with scala.Serializable {
