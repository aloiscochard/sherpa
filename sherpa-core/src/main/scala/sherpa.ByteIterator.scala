...
object ByteIterator {
  object ByteArrayIterator {
    ...
    protected[sherpa] def apply(array: Array[Byte]): ByteArrayIterator =
      new ByteArrayIterator(array, 0, array.length)

    protected[sherpa] def apply(array: Array[Byte], from: Int, until: Int): ByteArrayIterator =
  ...
  object MultiByteArrayIterator {
    ...
    protected[sherpa] def apply(iterators: LinearSeq[ByteArrayIterator]): MultiByteArrayIterator =
  ...
  class MultiByteArrayIterator private (private var iterators: LinearSeq[ByteArrayIterator]) extends ByteIterator {
    ...
    private[sherpa] def ++:(that: ByteArrayIterator): this.type = {
